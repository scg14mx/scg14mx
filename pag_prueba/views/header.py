...
from pag_prueba.styles.colors import Color, TextColor
from pag_prueba.components.link_icon import link_icon
from pag_prueba.components.info_text import info_text
